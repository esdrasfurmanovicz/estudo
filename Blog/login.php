            ...
            <div class="areaLogin">
                <div>
                    ...
                    <form action="logar.php" method="post">
                        <div class="gap">
                            <div class="input_container ">
                                ...
                                <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" class="input_field" id="email_field" autocomplete="off">
                            </div>
                            <div class="input_container">
                                ...
                                <input placeholder="Password" title="Inpit title" name="senha" type="password" class="input_field" id="password_field" autocomplete="off">
                            </div>
                        </div>
                    ...
                    c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
                        ...
                        <p class="textCad">Ainda não tem uma conta? <strong class="strCad" onclick="cadastro()">Cadastre-se</strong></p>
                    </form>
                </div>
            </div>
...
<script src="js/jquery.mask.min.js"></script>
    <script>
        function cadastro() {
            const cadDiv = document.querySelector(".cadDiv")
            const close = document.querySelector("#close")
            cadDiv.style.display = "flex"
            close.onclick = () => {
